		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "project_01",
									"targetURL": "#project01projectb1901-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"project01projectb1901-display": {
								"semanticObject": "project01projectb1901",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project01.projectb1901",
									"url": sap.ui.require.toUrl("project01/projectb1901")
								}
							}
						}
					}
