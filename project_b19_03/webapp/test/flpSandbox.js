		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "umm.....",
									"targetURL": "#testprojectb1903-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testprojectb1903-display": {
								"semanticObject": "testprojectb1903",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=test.projectb1903",
									"url": sap.ui.require.toUrl("test/projectb1903")
								}
							}
						}
					}
