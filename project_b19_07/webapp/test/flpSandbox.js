		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Chart",
									"targetURL": "#projectb1907-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectb1907-display": {
								"semanticObject": "projectb1907",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectb1907",
									"url": sap.ui.require.toUrl("projectb1907")
								}
							}
						}
					}
