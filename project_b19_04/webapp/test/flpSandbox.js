		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "JSON CRUD",
									"targetURL": "#projectb1904-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectb1904-display": {
								"semanticObject": "projectb1904",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectb1904",
									"url": sap.ui.require.toUrl("projectb1904")
								}
							}
						}
					}
