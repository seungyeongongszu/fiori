		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#practiceb1901-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"practiceb1901-display": {
								"semanticObject": "practiceb1901",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=practiceb1901",
									"url": sap.ui.require.toUrl("practiceb1901")
								}
							}
						}
					}
